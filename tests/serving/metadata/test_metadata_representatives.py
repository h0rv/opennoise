...
from musix.serving.metadata.metadata_representatives import metadata_representatives
...
class MetadataRepresentativesTests(unittest.TestCase):
    def test_exports_existing_selected_examples_from_canonical_candidates(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            _database(database)
            with patch(
                "musix.serving.metadata.metadata_representatives._metadata_candidates",
