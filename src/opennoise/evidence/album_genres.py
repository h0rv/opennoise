...
from opennoise.adapters.wikidata import AlbumGenreEvidenceRecord as WikidataEvidence
...
from opennoise.sources.musicbrainz import AlbumGenreEvidenceRecord as MusicBrainzEvidence
