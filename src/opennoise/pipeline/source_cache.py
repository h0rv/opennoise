...
pinned public input bytes in an :class:`~opennoise.storage.ObjectStore`, then
...
from opennoise.storage import LocalObjectStore, ObjectKey, ObjectStore, ObjectWrite
...
async def acquire_source_cache(
    ...
    *,
    ...
    http_client = client or httpx.AsyncClient(
        ...
        headers={"User-Agent": "opennoise/0.1 (bounded metadata cache acquisition)"},
    )
    runtime = _AcquisitionRuntime(
