...
from opennoise.taxonomy.seeds.universe import SeedInput, normalize_label

if TYPE_CHECKING:
    from opennoise.evidence.reconstruction import GenreArtistEdge, ReconstructionInputs
    from opennoise.ingest.musicbrainz.coverage import CoverageReport
    from opennoise.storage import ObjectStore, ObjectWrite
    from opennoise.taxonomy.seeds.taxonomy import (
        GenreSeedPublicTaxonomyArtifact,
        PublicTaxonomyNode,
        SeedTaxonomyInference,
    )
    from opennoise.taxonomy.seeds.universe import SeedName
