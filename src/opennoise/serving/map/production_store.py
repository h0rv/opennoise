...
from opennoise.models.production_qa import ProductionMapOverviewCommunity  # noqa: TC001
from opennoise.serving.map.overview import build_overview_communities
