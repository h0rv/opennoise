...
from opennoise.models.modeling import DirectMembershipEvidence
...
if TYPE_CHECKING:
    from opennoise.ingest.musicbrainz.seed_targets import MusicBrainzSeedTargetArtifact
    from opennoise.models.modeling import PublicModelInput
    from opennoise.serving.public.artist_membership import NameUniverse
