...
class Settings(BaseSettings):
    ...
    production_map_path: Path | None = Field(
        ...
        validation_alias="OPENNOISE_PRODUCTION_MAP_PATH",
    )
    historical_signal_map_path: Path | None = Field(
        default=None, validation_alias="OPENNOISE_HISTORICAL_SIGNAL_MAP_PATH"
    )
    historical_membership_database_path: Path | None = Field(
        default=None, validation_alias="OPENNOISE_HISTORICAL_MEMBERSHIP_DATABASE_PATH"
    )
    open_construction_graph_path: Path | None = Field(
        ...
        validation_alias="OPENNOISE_OPEN_CONSTRUCTION_GRAPH_PATH",
    )
    open_construction_graph_v2_path: Path | None = Field(
        ...
        validation_alias="OPENNOISE_CONSTRUCTION_GRAPH_V2_PATH",
    )
    local_research_artist_evidence_enabled: bool = Field(
        default=False, validation_alias="OPENNOISE_LOCAL_RESEARCH_ARTIST_EVIDENCE_ENABLED"
    )
    local_research_artist_evidence_database_path: Path = Field(
        ...
        validation_alias="OPENNOISE_LOCAL_RESEARCH_ARTIST_EVIDENCE_DATABASE",
    )
    local_research_artist_evidence_artifact_path: Path = Field(
        ...
        validation_alias="OPENNOISE_LOCAL_RESEARCH_ARTIST_EVIDENCE_ARTIFACT",
    )
    local_research_artist_reverse_lookup_database_path: Path | None = Field(
        default=None,
        validation_alias="OPENNOISE_LOCAL_RESEARCH_ARTIST_REVERSE_LOOKUP_DATABASE",
    )
    local_research_artist_reverse_lookup_artifact_path: Path | None = Field(
        default=None,
        validation_alias="OPENNOISE_LOCAL_RESEARCH_ARTIST_REVERSE_LOOKUP_ARTIFACT",
    )
    local_research_seed_reconciliation_path: Path = Field(
        ...
        validation_alias="OPENNOISE_LOCAL_RESEARCH_SEED_RECONCILIATION",
    )
    local_research_adapter_report_path: Path = Field(
        ...
        validation_alias="OPENNOISE_LOCAL_RESEARCH_ADAPTER_REPORT",
    )
    ...
    local_research_reviewed_alias_context_artifact_path: Path = Field(
        ...
        validation_alias="OPENNOISE_LOCAL_RESEARCH_REVIEWED_ALIAS_CONTEXT_ARTIFACT",
    )
    local_research_reviewed_alias_context_receipt_path: Path = Field(
        ...
        validation_alias="OPENNOISE_LOCAL_RESEARCH_REVIEWED_ALIAS_CONTEXT_RECEIPT",
    )
    local_research_reviewed_alias_peer_index_path: Path = Field(
        ...
        validation_alias="OPENNOISE_LOCAL_RESEARCH_REVIEWED_ALIAS_PEER_INDEX",
    )
    local_research_artist_metadata_database_path: Path | None = Field(
        default=None, validation_alias="OPENNOISE_LOCAL_RESEARCH_ARTIST_METADATA_DATABASE"
    )
    local_research_artist_metadata_artifact_path: Path | None = Field(
        default=None, validation_alias="OPENNOISE_LOCAL_RESEARCH_ARTIST_METADATA_ARTIFACT"
    )
