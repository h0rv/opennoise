...
`OPENNOISE_MB_ARTIST_ARCHIVE`, `OPENNOISE_HISTORICAL_MEMBERSHIP_DATABASE`,
`OPENNOISE_MB_SPOTIFY_BRIDGE_OUTPUT`, `OPENNOISE_MB_SPOTIFY_BRIDGE_OBJECT_STORE`, and
`OPENNOISE_MB_SPOTIFY_BRIDGE_RECEIPT`.
