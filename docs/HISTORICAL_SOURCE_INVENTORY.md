...
| [NeroYuki genre/artist map](https://github.com/NeroYuki/everynoise_enhancement_script) | Commit `88bd6f6cac0be49cf58af364af5db6f323065375`, 2024-11-16; repository is MIT, data provenance separately unlicensed | Sealed local file: 81,672,845 bytes, SHA-256 `863a513a6da89735a69373a46ba58f6975eddb5d065964c577dfcacf18fffe20` | `enao_genre_artist_map_v1`. H3 source-scoped evidence only. Details and safe projection are below. |
...
The sample proves the H3 adapter shape. The full source now has a local-only SQLite projection. [Its coverage report](reports/HISTORICAL_H3_COVERAGE_20260904.json) records 6,289 matched H2 names, 145 unmatched names, and 306,136 projected observations. It does not prove that the source matches any Every Noise data date, includes all members, or provides ranked artist pages. The source policy permits normalization only.
