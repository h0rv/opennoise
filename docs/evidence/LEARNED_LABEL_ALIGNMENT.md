...
The task requires `MUSIX_MB_SEED_TARGET_ARTIFACT`,
`MUSIX_SEED_RECONCILIATION_OUTPUT`,
`MUSIX_LEARNED_LABEL_ALIGNMENT_OUTPUT`,
`MUSIX_LEARNED_LABEL_ALIGNMENT_OBJECT_STORE`, and
`MUSIX_LEARNED_LABEL_ALIGNMENT_RECEIPT`.
