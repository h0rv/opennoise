"""Write the local fixed sparse genre hybrid transfer evaluation."""
...
from opennoise.ml.sparse_genre_hybrid_transfer import evaluate_sparse_genre_hybrid_transfer
...
def main() -> int:
    """Refuse replacement and evaluate only verified local inputs."""
    parser = argparse.ArgumentParser(prog="evaluate-sparse-genre-hybrid-transfer")
    ...
    report = evaluate_sparse_genre_hybrid_transfer(
