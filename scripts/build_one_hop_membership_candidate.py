...
def main() -> None:
    ...
    policy = OneHopMembershipCandidatePolicy.model_validate_json(
    ...
    with closing(_read_only(arguments.catalog_db)) as catalog, closing(
        _read_only(arguments.listenbrainz_db)
    ) as listenbrainz:
    ...
    print(artifact.model_dump_json(include={"output_sha256", "coverage"}, indent=2))
