"""Write a local-only bounded native release-group observation receipt."""
...
def main() -> int:
    """Use the existing local receipt and archive without network access."""
    ...
    report = build_release_group_native_observation(
        ...
        ReleaseGroupNativeObservationSettings(sample_size=arguments.sample_size),
    )
