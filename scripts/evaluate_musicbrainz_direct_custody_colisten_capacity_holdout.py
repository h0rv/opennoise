"""Write the fixed capacity-controlled local co-listen retrieval evaluation."""
...
from opennoise.peers.direct_custody_colisten_capacity_holdout import (
    evaluate_direct_custody_colisten_capacity_holdout,
)


def main() -> int:
    """Refuse output replacement and evaluate only verified local inputs."""
    parser = argparse.ArgumentParser(
        prog="evaluate-musicbrainz-direct-custody-colisten-capacity-holdout"
    )
    ...
    report = evaluate_direct_custody_colisten_capacity_holdout(
