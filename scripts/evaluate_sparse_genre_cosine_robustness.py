"""Write the local fixed-fold sparse cosine robustness checkpoint."""
...
from opennoise.ml.sparse_genre_cosine_robustness import (
    evaluate_sparse_genre_cosine_robustness,
)
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(prog="evaluate-sparse-genre-cosine-robustness")
    ...
    report = evaluate_sparse_genre_cosine_robustness(
