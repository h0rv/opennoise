"""Write a create-only local Last.fm direct-custody retrieval report."""
...
from opennoise.analysis.lastfm_direct_custody_holdout import evaluate_lastfm_direct_custody_holdout


def main() -> int:
    """Evaluate pinned local aggregate custody without producing public output."""
    ...
    parser.add_argument("--listenbrainz-database", type=Path)
    parser.add_argument("--listenbrainz-receipt", type=Path)
    ...
    report = evaluate_lastfm_direct_custody_holdout(
